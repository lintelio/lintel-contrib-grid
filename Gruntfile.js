/*
 * lintel-contrib-grid
 * https://github.com/lintelio/lintel-contrib-grid
 *
...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    sass: {
      ...
      dist: {
        files: {
          '<%= lintel.dist %>/grid.css': 'sass/lintel-core-loader.scss'
        }
      }
    },
    ...
    webshot: {
      xs: {
        options: {
          siteType: 'url',
          site: 'http://localhost:4554/grid.html',
